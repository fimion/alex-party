/**
 * forked from https://github.com/web-platform-dx/baseline-status/blob/c698fe4ee2e7b25fdbf55d2e07b2abe8d938eae4/baseline-icon.js
 */
import {LitElement, html, css} from 'lit';

/**
 *
 * @type {Record<string, import("lit-html").TemplateResult<1>>}
 */
const icons = {
  'limited': html`
